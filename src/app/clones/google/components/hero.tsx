        ...
        <div className="w-full absolute top-[20%] left-1/2 -translate-x-1/2">
            <div>
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="flex items-center rounded-full p-4 w-2/3 bg-[#4D5156] justify-around my-4">
                        <div className="mx-2">
                    ...
                    <div className="flex my-4 gap-2 ">
                        <div className="bg-[#303134] rounded-md p-2">
                            Google Search
                        </div>
                        <div className="bg-[#303134] rounded-md p-2">
                            Im Feeling Lucky
                    ...
                    <div className="flex flex-wrap gap-2 justify-center items-center text-sm">
                        Google offers in:{' '}
                        <div className="flex flex-wrap justify-center items-center gap-1 text-blue-400">
                            <div>हिन्दी</div>
                            <div>বাংলা</div>
                            <div>తెలుగు</div>
                            <div>मराठी</div>
